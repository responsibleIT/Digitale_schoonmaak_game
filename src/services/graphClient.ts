...
export class GraphClient {
  // accessToken ignored in mock
  constructor(_accessToken?: string) {}

  async listUserDrive(): Promise<DriveItem[]> {
    // Dummy files to test the flow
    return [
      { id: "f-001", name: "rapport.docx", size: 120_000 },
      { id: "f-002", name: "dataset.csv",  size: 5_000_000 },
      { id: "f-003", name: "screenshot.png", size: 800_000 },
      { id: "f-004", name: "video.mp4", size: 45_000_000 },
      { id: "f-005", name: "archive.zip", size: 210_000_000 },
    ];
  }

  async deleteItem(_itemId: string): Promise<void> {
    // Mock: do nothing. In real Graph we'd DELETE /me/drive/items/{id}
    return;
  }
}
